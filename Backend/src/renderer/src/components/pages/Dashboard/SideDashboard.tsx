...
import { faPlus, faGlobe, faEllipsisV, faTrash, faPen } from '@fortawesome/free-solid-svg-icons';
import Dialog from './Dialog';

const SideDashboard = (): React.JSX.Element => {
  const [projects, setProjects] = useState<string[]>(['Portfolio v1', 'Blog Site', 'Ecom Template']);
